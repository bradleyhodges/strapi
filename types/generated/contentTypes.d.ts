...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    CanonicalSlug: Schema.Attribute.UID<'Title'> & Schema.Attribute.Required;
    ...
    EventEnd: Schema.Attribute.DateTime;
    EventStart: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMediaReleaseMediaRelease
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    OfficialSubject: Schema.Attribute.String & Schema.Attribute.Required;
    PublishAuthor: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    publishedAt: Schema.Attribute.DateTime;
    Tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    Title: Schema.Attribute.String & Schema.Attribute.Required;
    Type: Schema.Attribute.Enumeration<['media-release', 'statement']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    Slug: Schema.Attribute.UID<'TagName'> & Schema.Attribute.Required;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    media_releases: Schema.Attribute.Relation<
      ...
      'api::media-release.media-release'
    >;
    NewsAuthor: Schema.Attribute.Relation<
      'oneToMany',
      'api::news-item.news-item'
    >;
    password: Schema.Attribute.Password &
